...
if (!file.exists(file.path(dat_dir, "all_schools.csv"))) {
    ...
    ## repo path
    repo_url <- "https://raw.githubusercontent.com/edquant/data/main/sch_test/all_schools.csv"
...
deviations are somewhat different due to sampling variation):
...
Across the years, I find much variation in subject-specific test
scores across the four schools under review. No single school stood
apart from the others in all subjects or across time. Two
recommendations follow.

First, it may be that district students could benefit from more
cross-school interaction among teachers, particularly so that
successful subject-specific practices and lessons may be replicated in
classrooms across the district. Though we do not want to remove our
best teachers from the classroom, the district might consider
expanding our current teacher mentorship program to include
cross-school mentor / mentee pairings. 

Second, the district should consider other metrics of student
success. While the end-of-year tests have been validated by
researchers and come with endorsements from other districts, they
remain only one measure of student achievement and, in our case, a
noisy measure at best. More formal analyses are warranted, but the
district might consider whether the costs of the tests are repaid in
useful information. The money may be better spent on other district
priorities. 
